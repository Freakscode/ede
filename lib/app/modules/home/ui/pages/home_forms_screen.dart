...
import 'package:caja_herramientas/app/modules/home/ui/widgets/completed_form_card_widget.dart';
...
class _HomeFormsScreenState extends State<HomeFormsScreen> {
                  ...
                  return Column(
                    children: [
                      ...
                      CompletedFormCardWidget(
                        form: form,
                        onDownload: () => _handleDownload(context, form),
                        onAssociateToSIRE: () => _handleAssociateToSIRE(context, form),
                        onSendEmail: () => _handleSendEmail(context, form),
  ...
  void _handleDownload(BuildContext context, FormDataModel form) {
    // TODO: Implementar lógica de descarga
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Descargando formulario: ${form.title}'),
        backgroundColor: Colors.orange,
      ),
    );
  }

  void _handleAssociateToSIRE(BuildContext context, FormDataModel form) {
    // TODO: Implementar lógica de asociación a SIRE
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Asociando a SIRE: ${form.title}'),
        backgroundColor: Colors.orange,
      ),
    );
  }

  void _handleSendEmail(BuildContext context, FormDataModel form) {
    // TODO: Implementar lógica de envío por correo
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Enviando por correo: ${form.title}'),
        backgroundColor: Colors.orange,
      ),
    );
  }
